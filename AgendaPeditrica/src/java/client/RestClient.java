...
/**
 * Jersey REST client generated for REST resource:HijosFacadeREST
 * [ws.database.hijos]<br>
 * USAGE:
 * <pre>
...
public class RestClient {
    ...
    private static final String BASE_URI = "http://localhost:49275/Agenda/webresources";

    public RestClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("ws.database.hijos");
    }
